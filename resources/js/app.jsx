...
function Login({ onLogin }) {
    ...
    className="btn mt-3 min-h-12 w-full flex items-center justify-center gap-2 border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-medium py-2.5 px-4 rounded-lg shadow-sm transition-all text-sm cursor-pointer"
>
