...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/events', [ApiController::class, 'store'])->middleware('role:PIC');
    ...
    Route::post('/notifications/{notification}/read', [ApiController::class, 'read']);
    Route::get('/users', [ApiController::class, 'users'])->middleware('role:ADMIN');
    Route::post('/users/{user?}', [ApiController::class, 'saveUser'])->middleware('role:ADMIN');
    Route::get('/venues', [ApiController::class, 'venues'])->middleware('role:ADMIN');
    Route::post('/venues/{venue?}', [ApiController::class, 'saveVenue'])->middleware('role:ADMIN');
